  ...
  <div class="flooring-step">
    ...
    <div class="inputs-stack">
      ...
      <section class="input-block mb-4 pb-4 border-bottom">
        ...
        <p class="text-muted small mb-3">Choose skirting height.</p>
      ...
      <section class="input-block mb-4 pb-4 border-bottom">
        ...
        <div class="option-grid two">
          <button
            ...
            @click="store.flooring.hasParquet = true"
          >
          ...
          <button
            ...
            @click="store.flooring.hasParquet = false"
          >
            <span class="choice-icon">×</span>
            <strong>No</strong>
      ...
      <section class="input-block">
        ...
        <div class="option-grid two">
          <button
            ...
            @click="store.flooring.hasGlassWork = true"
          >
            <span class="choice-icon">✓</span>
            <strong>Yes</strong>
          ...
          <button
            ...
            @click="store.flooring.hasGlassWork = false"
          >
            <span class="choice-icon">×</span>
            <strong>No</strong>
